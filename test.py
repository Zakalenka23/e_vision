...
def main():
    ...
    while(cap.isOpened()):
        ...
        lines = cv2.HoughLinesP(cropped_image,2,np.pi/180, houhgVoteTrashold, minLineLength=5, maxLineGap=30)
        print(cv2.HoughLines(cropped_image,1,np.pi/180,houhgVoteTrashold))
